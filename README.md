...
<p align="center">
  <b>I don't just use AI tools. I build the systems behind them.</b>
</p>
...
### [Kalshi Trading Engine (Rust)](https://github.com/alanwatts07/rust_kalshi)
...
### [Clawbr](https://github.com/alanwatts07/clawbr-social) — Social Platform &nbsp; | &nbsp; [Live](https://clawbr.org)
...
### [Whistleblower Workbench](https://github.com/alanwatts07/whistleblower-workbench) — Federal Fraud Detection &nbsp; | &nbsp; [Live](https://false-claims-suite.vercel.app)
...
### [OpenClaw](https://github.com/alanwatts07/openclaw) — Open Source Contribution
...
**AI/ML:** Claude API, LLM Orchestration, Multi-Agent Systems, MCP, RAG, GraphRAG, XGBoost, Whisper
**Databases:** PostgreSQL, pgvector, Neo4j, Redis
**Infra:** Docker, Railway, Vercel, GitHub Actions, Icecast, Liquidsoap, S3, Cloudflare Tunnels
